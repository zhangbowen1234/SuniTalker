...
public class ContactListAdapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ContactListAdapter2(Context context, List<ContactMemberBean> data) {
        contactList = data;
        Log.e("data", data + "");
        mContext = context;
...
/**
 *  一：自定义的ViewHolder，持有每个Item的的所有界面元素
 */
    /**
     * (1)新朋友Holder
     */
...
//    }
    ...
    /**
     * 二：在该方法中我们创建一个ViewHolder并返回，ViewHolder必须有一个带有View的构造函数，
