 ...
 */
package com.silver.chat.view.recycleview;
...
import com.silver.chat.view.recycleview.animation.ScaleInAnimation;
import com.silver.chat.view.recycleview.animation.SlideInBottomAnimation;
import com.silver.chat.view.recycleview.animation.SlideInLeftAnimation;
import com.silver.chat.view.recycleview.animation.SlideInRightAnimation;
import com.silver.chat.view.recycleview.entity.IExpandable;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * View to show if load ic_menu_more failed.
     */
    ...
    /**
     * when adapter's data size than pageSize and enable is true,the loading ic_menu_more function is enable,or disable
     *
     * @param pageSize
     */
...
//        notifyItemRangeInserted(mData.size() - newData.size() + getHeaderLayoutCount(), newData.size());
    ...
    /**
     * Set the view to show when load ic_menu_more failed.
     */
    ...
    /**
     * Call this method when load ic_menu_more failed.
     */
    ...
    /**
     * Determine whether it is loaded ic_menu_more
     *
     * @return
     */
