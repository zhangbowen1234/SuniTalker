...
import com.silver.chat.database.dao.BaseDaoImp;
...
public abstract class BaseDBHelper extends OrmLiteSqliteOpenHelper {
	...
	public BaseDBHelper(Context context, String databaseName,SQLiteDatabase.CursorFactory factory, int databaseVersion,
						Class<?>[] modelClasses) {
