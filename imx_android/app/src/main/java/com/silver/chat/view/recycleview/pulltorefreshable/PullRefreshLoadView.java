package com.silver.chat.view.recycleview.pulltorefreshable;
...
public class PullRefreshLoadView extends LinearLayout {
    ...
    private TextView last_refresh_time;//最后刷新时间
    ...
    public final static String PULL_TO_REFRESH = "下拉可以刷新";
    public final static String RELEASE_TO_REFRESH = "松开立即刷新";
    ...
    private void initView(Context context) {
        ...
        last_refresh_time = (TextView) findViewById(R.id.last_refresh_time);
    ...
    public void setState(int state) {
        ...
        if (state == STATE_REFRESHING) {
            ...
            last_refresh_time.setVisibility(INVISIBLE);
        } else if (state == STATE_PULL_TO_REFRESH) {
            mArrowIv.setVisibility(View.VISIBLE);
            mLoader.setVisibility(View.INVISIBLE);
            mStatusTv.setText(PULL_TO_REFRESH );
            last_refresh_time.setVisibility(VISIBLE);
            last_refresh_time.setText("最后更新：今天" + DateUtils.formatTimeSimple(System.currentTimeMillis()));
            if (mState == STATE_RELEASE_TO_REFRESH) {
